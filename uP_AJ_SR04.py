...
class AJ_SR04:
    def __init__(self, COM = 2, sampleInterval = 1000):
        self.max_distance = 1000
        self.min_distance = 20
        self.max_volume = 1000
        self.sampleInterval = sampleInterval
        self.distance = None
        self._lastGoodDistance = 0
        self.err = 0
        if COM == 1:
    ...
    async def _run(self, sampleInterval):
        self.measurements = Measurements(self.max_distance, self.min_distance, self.max_volume)
        ...
        if self.uart.any() >= 4: # before was  == 4
            ...
            if checkData == raw_distance[3]:
                ...
                if rawDistance <= 10000:
                    self.err = 0
                    self._lastGoodDistance = rawDistance
                    return rawDistance
                else:
